...
public class Chunk : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            { Voxel.VoxelType.Grass, grassMaterial },
            { Voxel.VoxelType.Stone, stoneMaterial },
    ...
    private Voxel.VoxelType DetermineVoxelType(float x, float y, float z)
    {
        ...
        float noiseValue = Noise.CalcPixel3D((int)x + 1000000, (int)y + 1000000, (int)z + 1000000, 0.1f);
    ...
    private void GenerateMesh()
    {
        ...
        meshRenderer.material = World.Instance.material; //Enara
        ...
        //            VoxelPoolManager.Instance.ShowGrassVoxel(voxel.position);
        //            break;
        //        case Voxel.VoxelType.Water:
        //            VoxelPoolManager.Instance.ShowWaterVoxel(voxel.position);
        //            break;
        //    }
        //}
    }
